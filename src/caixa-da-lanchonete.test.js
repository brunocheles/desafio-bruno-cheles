...
describe('CaixaDaLanchonete', () => {
    ...
    // Testes inseridos para verificar possíveis inserções erradas e o básio de pedir item com item extra
    test.each([
        ['com mais valores em quantidade no pedido', 'dinheiro', 'Quantidade inválida!', ['cafe,1,2']],
        ['com quantidade negativa', 'credito', 'Quantidade inválida!', ['cafe,-1']],
        ['com quantidade quantidade quebrada', 'debito', 'Quantidade inválida!', ['cafe,1.2']],
        ['com itens que não estão em um objeto', 'debito', 'Item inválido!', 'sanduiche,2'],
        ['cafe com chantily', 'debito', 'R$ 4,50', ['cafe,1','chantily,1']],
        ['cafe com chantily', 'debito', 'R$ 6,00', ['cafe,1','chantily,2']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});